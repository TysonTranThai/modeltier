      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mb-4">
          <div className="relative w-full sm:w-80">
            <Search className="absolute left-3 top-2.5 h-4 w-4 text-[#A89280]" />
            <input
              type="text"
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#2E170E] text-[#D8C4B6]">
                {calculatedRows.map((row, idx) => {
                  ...
                  return (
                    <tr key={row.model.id} className="hover:bg-[#2E170E]/50 transition-colors">
                      <td className="p-4 sm:pl-6">
                        ...
                        <span className="text-[11px] text-[#A89280]">{row.model.creator}</span>
                      </td>
                      ...
                      <td className="p-4 hidden sm:table-cell">
                        <span className="text-xs text-[#D8C4B6] flex items-center gap-1.5">
