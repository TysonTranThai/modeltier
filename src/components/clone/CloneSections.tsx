  ...
  return (
    <div className="space-y-16 mt-16 text-[#FFF6EE]">
      ...
      <section id="coding-agents" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        ...
        <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-bold font-serif flex items-center gap-1.5 text-[#FFF6EE]">
              <span>Agentic Software Engineering Benchmarks</span>
              <ArrowUpRight className="h-4 w-4 text-[#FF8452]" />
            </h3>
            <span className="text-xs text-[#A89280] font-mono">SWE-bench Verified % Resolved</span>
          </div>
          ...
          <div className="space-y-3.5">
            {[
              ...
              <div key={idx} className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 p-3 rounded-xl hover:bg-[#2F1910] border border-[#381E12] transition-colors">
                ...
                <div className="flex items-center gap-4 text-xs font-mono">
                  <span className="text-[#A89280]">Cost: <strong className="text-[#FFF6EE]">{item.cost}</strong></span>
                  <span className="text-[#A89280]">Time: <strong className="text-[#FFF6EE]">{item.speed}</strong></span>
                  <div className="flex items-center gap-2 w-32 justify-end">
                    <div className="w-16 bg-[#140A06] h-2.5 rounded-full overflow-hidden">
      ...
      <section id="media-leaderboards" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Image &amp; Video</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs text-[#A89280] font-mono">Arena Elo</span>
            </div>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex items-center justify-between text-xs py-2 border-b border-[#381E12] last:border-0">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex items-center justify-between text-xs py-2 border-b border-[#381E12] last:border-0">
                  ...
                  <span className="font-bold text-purple-400 font-mono">{m.elo}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* ================= SECTION 4: SPEECH ================= */}
      <section id="speech-leaderboards" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Speech</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="border-r border-[#381E12] pr-4 last:border-0">
              <h4 className="text-xs font-bold text-[#A89280] uppercase tracking-wider mb-3 font-mono">Text to Speech Quality</h4>
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between text-[#D8C4B6]"><span>OpenAI TTS HD</span><span className="font-mono">1215 Elo</span></div>
                <div className="flex justify-between text-[#D8C4B6]"><span>Cartesia Sonic</span><span className="font-mono">1198 Elo</span></div>
              </div>
            </div>

            <div className="border-r border-[#381E12] pr-4 last:border-0">
              <h4 className="text-xs font-bold text-[#A89280] uppercase tracking-wider mb-3 font-mono">Speech to Text Accuracy</h4>
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between text-[#D8C4B6]"><span>Deepgram Nova-2</span><span className="font-mono">4.5% WER</span></div>
                <div className="flex justify-between text-[#D8C4B6]"><span>AssemblyAI Universal</span><span className="font-mono">5.1% WER</span></div>
              </div>
            </div>

            <div>
              <h4 className="text-xs font-bold text-[#A89280] uppercase tracking-wider mb-3 font-mono">Realtime Audio Latency</h4>
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between text-[#D8C4B6]"><span>Gemini 2.0 Realtime</span><span className="font-mono">290 ms</span></div>
                <div className="flex justify-between text-[#D8C4B6]"><span>OpenAI 4o Realtime</span><span className="font-mono">320 ms</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="capability-indices" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Capability Indices</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            return (
              <div key={idx} className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-5 shadow-card-espresso hover:border-[#FF6B35]/50 transition-all">
                <div className="flex items-center justify-between text-[#A89280] mb-2">
                  <span className="text-xs font-bold text-[#D8C4B6]">{item.title}</span>
                  <Icon className="h-4 w-4 text-[#FF6B35]" />
                </div>
                <div className="text-2xl font-bold font-mono text-[#FFF6EE]">{item.score}</div>
                <div className="text-[11px] text-[#A89280] mt-1">Leader: <strong className="text-[#FF8452]">{item.top}</strong></div>
              </div>
            );
          })}
        </div>
      ...
      <section id="intelligence-breakdown" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Benchmarks</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            {[
              ...
              <div key={idx} className="p-3 rounded-xl border border-[#381E12] bg-[#1A0E08]/70">
                <span className="font-bold text-[#FF8452] font-mono">{b.id}</span>
                <p className="text-[#A89280] mt-1 leading-relaxed">{b.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="openness" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Openness Index</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-[#381E12]">
              {[
                ...
                <tr key={idx} className="hover:bg-[#2F1910] transition-colors">
                  <td className="py-2.5 px-3 font-semibold text-[#FFF6EE] flex items-center gap-2">
                    <CompanyLogo creator={m.creator} size={14} />
                    <span>{m.name}</span>
                  </td>
                  <td className="py-2.5 px-3 text-[#D8C4B6]">{m.weights}</td>
                  <td className="py-2.5 px-3 text-[#D8C4B6]">{m.meth}</td>
                  <td className="py-2.5 px-3 text-[#D8C4B6]">{m.data}</td>
                  <td className="py-2.5 px-3 font-bold text-emerald-400 font-mono">{m.score}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section id="output-tokens" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Output Tokens</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso">
          <div className="space-y-3 text-xs">
            {[
              ...
              <div key={idx} className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 p-3 rounded-xl border border-[#381E12] bg-[#1A0E08]/60">
                <span className="font-semibold text-[#FFF6EE]">{item.name}</span>
                <div className="flex items-center gap-4 text-[#A89280] font-mono">
                  <span>Reasoning: <strong className="text-[#FF8452]">{item.reasoning}</strong></span>
                  <span>Answer: <strong className="text-[#FFF6EE]">{item.answer}</strong></span>
                  <span>Context: <strong className="text-[#FFF6EE]">{item.context}</strong></span>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* ================= SECTION 9: COST ================= */}
      <section id="price-and-cost" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Cost</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse font-mono">
            <thead>
              <tr className="border-b border-[#381E12] text-[#A89280] font-semibold uppercase tracking-wider">
            ...
            <tbody className="divide-y divide-[#381E12]">
              {[
                ...
                <tr key={idx} className="hover:bg-[#2F1910] transition-colors">
                  <td className="py-2.5 px-3 font-semibold text-[#FFF6EE] font-sans flex items-center gap-2">
                    <CompanyLogo creator={m.creator} size={14} />
                    <span>{m.name}</span>
                  </td>
                  <td className="py-2.5 px-3 text-[#D8C4B6]">{m.in}</td>
                  <td className="py-2.5 px-3 text-[#D8C4B6]">{m.out}</td>
                  <td className="py-2.5 px-3 text-emerald-400">{m.cache}</td>
                  <td className="py-2.5 px-3 font-bold text-[#FF8452]">{m.task}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section id="speed" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Speed &amp; Latency</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso">
            <h3 className="text-base font-bold font-serif mb-4 flex items-center justify-between text-[#FFF6EE]">
              ...
              <span className="text-xs text-[#A89280] font-normal font-mono">Higher is better</span>
            </h3>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="flex items-center justify-between text-xs py-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-24 bg-[#140A06] h-2 rounded-full overflow-hidden">
          ...
          <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso">
            <h3 className="text-base font-bold font-serif mb-4 flex items-center justify-between text-[#FFF6EE]">
              ...
              <span className="text-xs text-[#A89280] font-normal font-mono">Lower is better</span>
            </h3>
            <div className="space-y-3">
              {[
      ...
      <section id="providers" className="scroll-mt-24 pt-6 border-t border-[#3D2216]">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center gap-3">
            <span className="w-4 h-4 bg-[#FF6B35] rounded-sm shadow-glow-orange" aria-hidden="true" />
            <h2 className="text-2xl font-bold font-serif text-[#FFF6EE]">Providers</h2>
          </div>
          <p className="text-xs text-[#D8C4B6] max-w-3xl font-light">
        ...
        <div className="rounded-2xl border border-[#472718] bg-[#24130C]/90 p-6 shadow-card-espresso overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse font-mono">
            <thead>
              <tr className="border-b border-[#381E12] text-[#A89280] font-semibold uppercase tracking-wider font-sans">
            ...
            <tbody className="divide-y divide-[#381E12]">
              {[
                ...
                <tr key={idx} className="hover:bg-[#2F1910] transition-colors">
                  <td className="py-2.5 px-3 font-semibold text-[#FFF6EE] font-sans">{p.name}</td>
                  <td className="py-2.5 px-3 text-emerald-400 font-bold">{p.accuracy}</td>
                  <td className="py-2.5 px-3 text-[#D8C4B6]">{p.ttft}</td>
                  <td className="py-2.5 px-3 text-[#FF8452] font-bold">{p.tps}</td>
                  <td className="py-2.5 px-3 text-[#A89280]">{p.uptime}</td>
                </tr>
              ))}
            </tbody>
          </table>
