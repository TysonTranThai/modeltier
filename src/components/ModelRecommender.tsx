    ...
    <section id="finder" className="py-14 lg:py-20 bg-[#180D07] border-y border-[#3D2216] scroll-mt-16 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 rounded-full bg-indigo-500/10 px-3.5 py-1 text-xs font-semibold text-indigo-300 border border-indigo-500/20 mb-3">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="rounded-full bg-emerald-950 px-2 py-0.5 text-xs font-bold text-emerald-400 border border-emerald-800/40">
